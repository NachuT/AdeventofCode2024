            ...
            for (r1, c1) in coords:
                for (r2, c2) in coords:
                    if (r1, c1) != (r2, c2):
                        ...
                        if (distance1 == 2 * distance2 or distance1 * 2 == distance2) and 0 <= row < num_rows and 0 <= col < num_cols and (delta_r1 * delta_c2 == delta_c1 * delta_r2):
                            set_part1.add((row, col))

result_part1 = len(set_part1)
print(result_part1)
